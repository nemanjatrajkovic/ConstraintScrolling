...
class RecyclerViewFragment : Fragment() {
    ...
    private lateinit var scrollingView: NestedScrollView
...
//        scrollingView = rootView.findViewById(R.id.scrollingView)
//        ViewCompat.setNestedScrollingEnabled(scrollingView, true)
